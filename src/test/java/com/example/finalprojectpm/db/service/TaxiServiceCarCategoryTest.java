...
class TaxiServiceCarCategoryTest {
    ...
    @Test
    void insertCarCategory() throws DBException, SQLException, ApplicationEXContainer.ApplicationCantRecoverException {
    ...
    void insertCarCategoryException() throws DBException, SQLException {
        ...
        Throwable thrown = assertThrows(ApplicationEXContainer.ApplicationCantRecoverException.class,()-> serviceCarCategory.insertCarCategory(carCategory));
        assertEquals("can't close some resources",thrown.getMessage());
    }

    @Test
    void deleteCarCategory() throws DBException, SQLException, ApplicationEXContainer.ApplicationCantRecoverException {
    ...
    void deleteCarCategoryException() throws DBException, SQLException {
        ...
        Throwable thrown = assertThrows(ApplicationEXContainer.ApplicationCantRecoverException.class,()-> serviceCarCategory.deleteCarCategory(carCategory));
        assertEquals("can't close some resources",thrown.getMessage());
    }

    @Test
    void findCarCategory() throws DBException, SQLException, ApplicationEXContainer.ApplicationCantRecoverException {
    ...
    void findCarCategoryException() throws DBException, SQLException {
        ...
        Throwable thrown = assertThrows(ApplicationEXContainer.ApplicationCantRecoverException.class,()-> serviceCarCategory.findCarCategory(carCategory));
        assertEquals("can't close some resources",thrown.getMessage());
    }

    @Test
    void updateCarCategory() throws DBException, SQLException, ApplicationEXContainer.ApplicationCantRecoverException {
    ...
    void updateCarCategoryException() throws DBException, SQLException {
        ...
        Throwable thrown = assertThrows(ApplicationEXContainer.ApplicationCantRecoverException.class,()-> serviceCarCategory.updateCarCategory(carCategory,newPrice));
        assertEquals("can't close some resources",thrown.getMessage());
    }
    @Test
    void findAllCarC() throws DBException, SQLException, ApplicationEXContainer.ApplicationCantRecoverException {
    ...
    void findAllCarCException() throws DBException, SQLException {
        ...
        Throwable thrown = assertThrows(ApplicationEXContainer.ApplicationCantRecoverException.class,()-> serviceCarCategory.findAllCarC());
        assertEquals("can't close some resources",thrown.getMessage());
    }

    @Test
    void findExistingCarC() throws DBException, SQLException, ApplicationEXContainer.ApplicationCantRecoverException {
    ...
    void findExistingCarCException() throws DBException, SQLException{
        ...
        Throwable thrown = assertThrows(ApplicationEXContainer.ApplicationCantRecoverException.class,()-> serviceCarCategory.findExistingCarC());
        assertEquals("can't close some resources",thrown.getMessage());
    }
    @AfterAll
