...
public interface OrderDao {
    ...
    int orderCountByUser(Connection connection,int userId) throws DBException, SQLException;
    List<Order> findOrdersByUser(Connection connection, int userId,int startRow, int rowsPerPage) throws DBException, SQLException;
